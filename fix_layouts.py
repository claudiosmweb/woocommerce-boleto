...
def replace(file_path):
    ...
    lines = {
        ...
        """    Imprima em impressora jato de tinta (ink jet) ou laser em qualidade normal ou alta (Não use modo econômico).\n""": """    <?php _e( 'Imprima em impressora jato de tinta (ink jet) ou laser em qualidade normal ou alta (N&atilde;o use modo econ&ocirc;mico).', 'wcboleto' ); ?>\n""",
        """    Utilize folha A4 (210 x 297 mm) ou Carta (216 x 279 mm) e margens mínimas à esquerda e à direita do formulário.\n""": """    <?php _e( 'Utilize folha A4 (210 x 297 mm) ou Carta (216 x 279 mm) e margens m&iacute;nimas &agrave; esquerda e &agrave; direita do formul&aacute;rio.', 'wcboleto' ); ?>\n""",
        """    Corte na linha indicada. Não rasure, risque, fure ou dobre a região onde se encontra o código de barras.\n""": """    <?php _e( 'Corte na linha indicada. N&atilde;o rasure, risque, fure ou dobre a regi&atilde;o onde se encontra o c&oacute;digo de barras.', 'wcboleto' ); ?>\n""",
        """    Caso não apareça o código de barras no final, clique em F5 para atualizar esta tela.\n""": """    <?php _e( 'Caso n&atilde;o apare&ccedil;a o c&oacute;digo de barras no final, clique em F5 para atualizar esta tela.', 'wcboleto' ); ?>\n""",
        """    Caso tenha problemas ao imprimir, copie a seqüencia numérica abaixo e pague no caixa eletrônico ou no internet banking:\n""": """    <?php _e( 'Caso tenha problemas ao imprimir, copie a seq&uuml;encia num&eacute;rica abaixo e pague no caixa eletr&ocirc;nico ou no internet banking:', 'wcboleto' ); ?>\n""",
        """    Linha Digitável:\n""": """    <?php _e( 'Linha Digit&aacute;vel:', 'wcboleto' ); ?>\n""",
        """    Recibo do Sacado\n""": """    <?php _e( 'Recibo do Sacado', 'wcboleto' ); ?>\n""",
        ...
        """    Ficha de Compensação\n""": """    <?php _e( 'Ficha de Compensa&ccedil;&atilde;o', 'wcboleto' ); ?>\n""",
        """    Cód. baixa\n""": """    <?php _e( 'C&oacute;d. baixa', 'wcboleto' ); ?>\n""",
        """    Valor documento\n""": """    <?php _e( 'Valor documento', 'wcboleto' ); ?>\n""",
        """    Valor:\n""": """    <?php _e( 'Valor:', 'wcboleto' ); ?>\n""",
