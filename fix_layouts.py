...
def replace(file_path):
    ...
    lines = {
        ...
        """<font style="font-size: 10px;">Autenticação mecânica - Ficha de Compensação</font>""": """<font style="font-size: 10px;"><?php _e( 'Autentica&ccedil;&atilde;o mec&acirc;nica - Ficha de Compensa&ccedil;&atilde;o', 'wcboleto' ); ?></font>""",
