...
do Sacado</b></div>
    ...
    <table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
      <tr>
        <td width=41>
          <?php $logo_empresa_src = empty( $logo ) ?  wcboleto_assets_url() . "images/logo_empresa.png" : $logo; ?>
          <IMG SRC="<?php echo $logo_empresa_src; ?>">
        </td>
    ...
    <table cellspacing=0 cellpadding=0 width=666 border=0>
      <tr>
        <td class=cp width=150>
          <span class="campo">
            <IMG src="<?php echo wcboleto_assets_url(); ?>images/logosicredi.jpg" width="150" height="40" border=0>
          </span>
        </td>
